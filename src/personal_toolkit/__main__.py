...
def main(argv=None):
    ...
    for command in ("init", "doctor", "urls", "install", "mcp", "worker", "model"):
    ...
    svc.add_argument("module", choices=("automation", "design"), nargs="?")
    ...
    try:
        if args.command == "init":
            ...
            print("Plausible (optional): http://localhost:8000")
            ...
            if args.action == "up" and not args.module:
                raise ValueError("Choose a module: pt services up automation OR pt services up design")
            ...
            if args.action == "up":
                ...
                services = {"automation": ["n8n", "pipeline-worker", "ollama"],
